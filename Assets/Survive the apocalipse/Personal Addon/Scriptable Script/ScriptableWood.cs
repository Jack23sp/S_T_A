...
[CreateAssetMenu(menuName = "uMMORPG Item/Wood", order = 999)]
public partial class ScriptableWood : ScriptableItem
{
    ...
    static Dictionary<int, ScriptableWood> cache;
    public static Dictionary<int, ScriptableWood> dict
    {
        get
        {
            // not loaded yet?
            if (cache == null)
            {
                ...
                ScriptableWood[] items = Resources.LoadAll<ScriptableWood>("");
