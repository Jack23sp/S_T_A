...
[CreateAssetMenu(menuName = "uMMORPG Item/Torch", order = 999)]
public partial class ScriptableTorch : EquipmentItem
{
    ...
    static Dictionary<int, ScriptableTorch> cache;
    public static Dictionary<int, ScriptableTorch> dict
    {
        get
        {
            // not loaded yet?
            if (cache == null)
            {
                ...
                ScriptableTorch[] items = Resources.LoadAll<ScriptableTorch>("");
