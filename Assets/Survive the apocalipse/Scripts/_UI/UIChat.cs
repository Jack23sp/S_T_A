...
public partial class UIChat : MonoBehaviour
{
    ...
    public Sprite messageSlotSprite;
    ...
    void Update()
    {
        ...
        if (player)
        {
            ...
            {
                yDimension += rectTransform.sizeDelta.y;
            }
        }
    ...
    public void AddMessage(ChatMessage message)
    {
        ...
        if (message.sender == Player.localPlayer.name)
        {
            go.GetComponent<Image>().sprite = messageSlotSprite;
            go.GetComponentInChildren<TextMeshProUGUI>().color = Color.white;
            go.GetComponentInChildren<TextMeshProUGUI>().text = message.Construct();
            go.GetComponentInChildren<UIChatEntry>().message = message;
        }
        else
        {
            go.GetComponentInChildren<TextMeshProUGUI>().text = message.Construct();
