...
public abstract class ScriptableQuest : ScriptableObjectNonAlloc
{
    ...
    public List<QuestAbility> ability = new List<QuestAbility>(); //
    public List<QuestBoost> Boosts = new List<QuestBoost>(); //
    public bool enterPremium = false; //
    public bool createBuilding = false; //
    public bool equipWeapon = false; //
    public bool equipBag = false; //
    public bool createGuild = false; //
    public bool createParty = false; //
    public bool makeGroupAlly = false; //
    public bool drink = false; //
    public bool eat = false; //
    public bool run = false; //
    public bool sneak = false; //
    public bool makeMarriage = false; //
    public bool sendAMessage = false; //
    public bool buyEmoji = false; //
    public bool openShop = false; //
    public int amountPlayerToKill = 0; //
    public int amountWoodToGather = 0; //
    public int amountRockToGather = 0; //
    public bool useTeleport; //
    public bool useInstantResurrect; //
    public bool makeATrade; //
    public int reachAmountOfFriends;
    public List<ZombieKill> killZombie = new List<ZombieKill>(); //
    public List<UpgradeBuilding> buildingUpgrade = new List<UpgradeBuilding>();
    public List<UpgradeItems> itemUpgrade = new List<UpgradeItems>();
    public SetSpawnpoint setSpawnpoint; //

    public List<CustomItem> itemRewards = new List<CustomItem>();

    public ScriptableQuest nextQuest;
    ...
    */
    public virtual string ToolTip(Player player, Quest quest)
    {
        ...
        tip.Replace("{REWARDCOIN}", rewardCoin.ToString());
