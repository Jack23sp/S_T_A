...
[CreateAssetMenu(menuName="uMMORPG Skill/Target Damage Zombie", order=999)]
public class TargetDamageSkillZombie : DamageSkill
{
    ...
    public override void Apply(Entity caster, int skillLevel)
    {
        ...
        caster.DealDamageAt(caster.target,damage.Get(skillLevel),
